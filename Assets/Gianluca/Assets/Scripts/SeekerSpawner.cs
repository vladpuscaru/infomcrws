...
public class SeekerSpawner : MonoBehaviour
{
    ...
    public int batchSize = 1000; // The number of seekers to spawn at once
    ...
    private Vector3 GetRandomSpawnPosition()
    {
        ...
        do
        {
            ...
            float xPosition = Random.Range(-500f, 500f);
            float zPosition = Random.Range(-500f, 500f);
            potentialPosition = new Vector3(xPosition, 2.5f, zPosition); // Y is 0 because it's a flat plane
